package com.example.chino_lee.mobileguard.m1home.adapter;
...
public class HomeAdapter extends BaseAdapter{;
    int[] imageId = {R.drawable.callmsgsafe,R.drawable.app,R.drawable.trojan,R.drawable.sysoptimize,R.drawable.taskmanager,R.drawable.netmanager,R.drawable.atools,R.drawable.settings};
