...
public class BlackContactAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.mStateTV = (TextView) view.findViewById(R.id.tv_black_fenlei);
        ...
        holder.mStateTV.setText(contactInfos.get(i).state);
        holder.mStateTV.setTextColor(context.getResources().getColor(R.color.bright_purple));
